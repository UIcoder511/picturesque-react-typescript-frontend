               ...
               >
                  ...
                  <Box sx={{ display: 'flex', gap: '10px' }}>
                     <Tooltip
                        disableInteractive
                        title={
                           isBookmarked ? 'Remove from Favourites' : 'Collect'
                        }
                     >
                        <IconButtonStyled
                           onClick={() => {
                              handleBookmarkButton(_id, isBookmarked);
                           }}
                        >
                           {isBookmarked ? (
                              <BookmarkIcon
                     ...
                     <Tooltip
                        disableInteractive
                        title={
                           isLiked ? 'You liked this. Click to undo' : 'Like'
                        }
                     >
                        <IconButtonStyled
                           onClick={() => {
                              handleLikeButton(_id, isLiked);
                           }}
                        >
                           {isLiked ? (
                              <FavoriteIcon
                     ...
                     <Tooltip disableInteractive title={'Download Image'}>
                        <IconButtonStyled
                           onClick={() => {
                              hanldeDownloadImage(photoId, orignalSrc);
                           }}
                        >
